...
class Matyas(object):
    ...
    def matyasFunction(self, x, y):
        # When we put define 0 to x and y, this must return 0
    ...
    def getFitness(self,individual):
        ...
        fitness = 10.0/(1.0+self.matyasFunction(real_x1,real_x2))
        #print(fitness)
        return fitness
    ...
    def printSolution(self,solution):
        ...
        print('x1=%g'%real_x1)
        print('x2=%g'%real_x2)
        print('f(x1,x2)=%g'%self.matyasFunction(real_x1,real_x2))
